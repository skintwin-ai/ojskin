...
<ul id="navigationPrimary" class="pkp_navigation_primary pkp_nav_list">
	...
	{* SKZ Dashboard Menu Item *}
	{if $currentJournal}
		<li>
			<a href="{url router=$smarty.const.ROUTE_PAGE page="skzDashboard"}">
			...
			<ul>
				...
				<li>
					<a href="{url router=$smarty.const.ROUTE_PAGE page="skzDashboard" op="agents"}">
						{translate key="Agent Status"}
					</a>
				</li>
				<li>
					<a href="{url router=$smarty.const.ROUTE_PAGE page="skzDashboard" op="workflow"}">
						{translate key="Workflow Visualization"}
					</a>
				</li>
				<li>
					<a href="{url router=$smarty.const.ROUTE_PAGE page="skzDashboard" op="analytics"}">
						{translate key="Analytics"}
					</a>
				</li>
			</ul>
		</li>
